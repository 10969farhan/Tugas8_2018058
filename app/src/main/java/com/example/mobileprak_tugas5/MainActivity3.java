...
import static com.example.mobileprak_tugas5.DBmain.TABLENAME;
...
import com.example.mobileprak_tugas5.databinding.ActivityMain3Binding;
    ...
    private void insertData() {
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Long rec = sqLiteDatabase.insert("Liquid", null, cv);
                if (rec != null) {
        ...
        binding.btnDisplay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivity3.this, DisplayData.class));
            }
        });
        ...
        binding.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (recedit != -1) {
                    Toast.makeText(MainActivity3.this, "Update Succesfully", Toast.LENGTH_SHORT).show();
                    ...
                    Intent a = new Intent(MainActivity3.this, DisplayData.class);
                    startActivity(a);
                }
            }
        });
